...
router.post('/:promoId', authenticate.verifyUser, (req, res) => {
    res.status(403).json('POST operation not supported on /promotions/'+ req.params.promoId);
})

router.put('/:promoId', authenticate.verifyUser, (req, res) => {
...
router.delete('/:promoId', authenticate.verifyUser, (req, res) => {
